...
with col22:
    f0 = st.slider(r' Densité de femelles sauvages initiale ($F_0$)', min_value = 0., max_value = K, value = 3., step=0.1, disabled = False)  

with col23:
    m0 = st.slider(r' Densité de mâles sauvages initiale ($M_0$)', min_value = 0., max_value = K, value = K/2, step=0.1) 
