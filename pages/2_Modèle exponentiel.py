...
with col23:
    r = st.slider(' Taux de natalité', min_value = 0, max_value = 1, value = 0.5, step=0.05, disabled = False) 

with col24:
    μ =  st.slider(' Taux de mortalité', min_value = 0, max_value = 1, value = 0.5, step = 0.05, disabled = False)
