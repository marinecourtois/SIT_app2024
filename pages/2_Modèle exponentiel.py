...
with col22:
    N0 = st.slider(r' Densité initiale ($N_0$)', min_value = 0., max_value = 10., value = 5., step=1.)  

with col23:
    r = st.slider(' Taux de natalité (r)', min_value = 0., max_value = 1., value = 0.5, step=0.05) 

with col24:
    μ =  st.slider(' Taux de mortalité (μ)', min_value = 0., max_value = 1., value = 0.5, step = 0.05)
